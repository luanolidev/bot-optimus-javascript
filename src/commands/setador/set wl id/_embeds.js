...
this.whitelist_liberar_embed = (serverName, interaction) => new EmbedBuilder()
.setAuthor({ name: '📋 Sistema de liberação de id - ' + interaction.guild.name })
.setDescription('**Clique no botão** para liberar seu id, após sua aprovação seu passaporte será liberado na cidade!\n\n• Você terá em média 1 minuto para responder cada questão.\n• Caso você reprova, terá que refazer.')
