...
const questions = require('../../database/questao')
const { Guild, User } = require('../../database/schemas')
const { check } = require('../../configs/utils/debug')
const { link_access_button1 } = require('./_button1')
...
module.exports = {
    execute: async (interaction) => {
        ...
        interaction.reply({ embed: [whitelist_popup_embed()], components: [link_access_button1(url)], ephemeral: true })
